...
def static():
    global STATIC_ROOT
    response = static_file('root.html', root=STATIC_ROOT)
...
def static():
    global STATIC_ROOT
    response = static_file('login.html', root=STATIC_ROOT)
    response.set_cookie('rtx_prefix', request.environ['YENOT_BASE_URL'])
    return response
...
def static():
    global STATIC_ROOT
    response = static_file('reports.html', root=STATIC_ROOT)
    response.set_cookie('rtx_prefix', request.environ['YENOT_BASE_URL'])
    return response
...
def get_lms_user_profile():
    global STATIC_ROOT
    response = static_file("profile.html", root=STATIC_ROOT)
    response.set_cookie('rtx_prefix', request.environ['YENOT_BASE_URL'])
    return response
...
def get_lms_technical():
    global STATIC_ROOT
    response = static_file("technical.html", root=STATIC_ROOT)
    response.set_cookie('rtx_prefix', request.environ['YENOT_BASE_URL'])
    return response
...
def get_lms_diagnostics():
    global STATIC_ROOT
    response = static_file("diagnostics.html", root=STATIC_ROOT)
    response.set_cookie('rtx_prefix', request.environ['YENOT_BASE_URL'])
    return response
